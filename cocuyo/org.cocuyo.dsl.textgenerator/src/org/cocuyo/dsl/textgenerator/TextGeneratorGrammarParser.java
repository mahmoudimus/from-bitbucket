...
public class TextGeneratorGrammarParser extends TextGeneratorGrammarCupParser implements IParser
{
	...
	public TextGeneratorGrammarParser(ICupLexer aLexer)
	{
		super(aLexer);
	...
	{
		//open-before-reduce//close-before-reduce
		for(IParserListener listener : fListeners)
		{
			listener.listenReduce(prodIndex);
		}
		//open-after-reduce//close-after-reduce
	}
	
	@Override
	public void debug_shift(java_cup.runtime.Symbol symbol)
	{
		//open-before-shift//close-before-shift
		for(IParserListener listener : fListeners)
		{
			listener.listenShift(symbol);
		}
		//open-after-shift//close-after-shift
	}
	
	@Override
	public void debug_message(String aMsg)
	{
		//open-before-message//close-before-message
		//open-after-message//close-after-message
	}
