...
public class LexParse extends java_cup.runtime.lr_parser {
	...
	/** Production table. */
	protected static final short _production_table[][] = unpackFromStrings(new String[] { "\000\113\000\002\002\004\000\002\006\006\000\002\006"
	...
	/** Parse-action table. */
	protected static final short[][] _action_table = unpackFromStrings(new String[] { "\000\156\000\006\002\uffff\041\004\001\002\000\016\003"
	...
	protected static final short[][] _reduce_table = unpackFromStrings(new String[] { "\000\156\000\004\006\004\001\001\000\004\003\007\001"
	...
	public void report_error(String message, Object info) {
		if (info instanceof java_cup.runtime.Symbol) {
			...
			if (s.sym == sym.EOF)
				...
				Out.error(scanner.file, ErrorMessages.SYNTAX_ERROR, s.left,
						s.right);
		} else
...
class CUP$LexParse$actions {
	...
	private RegExp makeRepeat(RegExp r, int n1, int n2, int line, int col) {
		...
		n2 -= n1;
		for (i = 0; i < n2; i++)
			result = new RegExp2(sym.CONCAT, result, new RegExp1(sym.QUESTION,
					r));
	...
	public final java_cup.runtime.Symbol CUP$LexParse$do_action(
		...
		case 58: // charclass ::= OPENCLASS HAT DASH classcontent CLOSECLASS 
		{
			...
			try {
				list.addElement(new Interval('-', '-'));
				charClasses
						.makeClassNot(list, Options.jlex && scanner.caseless);
			} catch (CharClassException e) {
				syntaxError(ErrorMessages.CHARSET_2_SMALL, closeleft,
						closeright);
			}
		...
		case 25: // actions ::= NOACTION 
		{
			...
			CUP$LexParse$result = new java_cup.runtime.Symbol(19/*actions*/,
					((java_cup.runtime.Symbol) CUP$LexParse$stack
							.elementAt(CUP$LexParse$top - 0)).left,
					((java_cup.runtime.Symbol) CUP$LexParse$stack
							.elementAt(CUP$LexParse$top - 0)).right, RESULT);
		...
		case 23: // act ::= REGEXPEND ACTION 
		{
			...
			Action a = (Action) ((java_cup.runtime.Symbol) CUP$LexParse$stack
					.elementAt(CUP$LexParse$top - 0)).value;
			RESULT = a;
			CUP$LexParse$result = new java_cup.runtime.Symbol(18/*act*/,
					((java_cup.runtime.Symbol) CUP$LexParse$stack
							.elementAt(CUP$LexParse$top - 1)).left,
					((java_cup.runtime.Symbol) CUP$LexParse$stack
							.elementAt(CUP$LexParse$top - 0)).right, RESULT);
		...
		case 22: // lookahead ::= LOOKAHEAD series DOLLAR 
		{
			...
			CUP$LexParse$result = new java_cup.runtime.Symbol(10/*lookahead*/,
					((java_cup.runtime.Symbol) CUP$LexParse$stack
							.elementAt(CUP$LexParse$top - 2)).left,
					((java_cup.runtime.Symbol) CUP$LexParse$stack
							.elementAt(CUP$LexParse$top - 0)).right, RESULT);
		...
		case 17: // rule ::= statesOPT hatOPT series lookahead NOACTION 
		{
			...
			int aright = ((java_cup.runtime.Symbol) CUP$LexParse$stack
					.elementAt(CUP$LexParse$top - 0)).right;
			Object a = (Object) ((java_cup.runtime.Symbol) CUP$LexParse$stack
					.elementAt(CUP$LexParse$top - 0)).value;
