...
public class TigerLexer extends TigerJFlexLexer implements ICupLexer
{
	private File fFile;
	...
	public TigerLexer(String aSource)
	{
	...
	public TigerLexer(File aFile) throws FileNotFoundException
	{
