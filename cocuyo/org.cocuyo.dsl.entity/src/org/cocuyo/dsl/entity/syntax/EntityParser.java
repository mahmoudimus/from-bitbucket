...
public class EntityParser extends EntityCupParser implements IParser
{
	...
	public EntityParser(ICupLexer aLexer)
	{
		super(aLexer);
	...
	/**
	 * Create a  EntityParser with a EntityLexer
	 */
	public EntityParser()
	{
		this(new EntityLexer());
	}
